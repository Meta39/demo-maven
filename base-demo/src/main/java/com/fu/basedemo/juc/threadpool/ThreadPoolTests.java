...
public class ThreadPoolTests {
    ...
    public void test() {
        //一池5线程
        try (ExecutorService threadPool1 = Executors.newFixedThreadPool(5)) {
    ...
    @Test
    public void test2() {
        try (ExecutorService threadPool2 = Executors.newSingleThreadExecutor()) {
    ...
    public void test3() {
        //一池可扩容线程
        try (ExecutorService threadPool3 = Executors.newCachedThreadPool()) {
