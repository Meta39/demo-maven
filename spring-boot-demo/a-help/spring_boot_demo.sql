...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES (1, '超级管理员', '2023-03-11 13:58:25', '2023-03-11 13:58:27', 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'salt', 'UyxF2P7oMr5LnxM4tmeq7Jq2cVXnQ+H9jWwLzwWjn8qL+veKNlHjoom6wHIFXl7ez8JVksKg0/+/j18U/IPiXezYTWlNsqQ4IE/VPWxpo/WG4idKAj8dCUVa2AK4A5fXj4GJFZKi95Rp8vZAzJbyp6QecMiG04XSqFiFNLFWlf4=', '超级管理员', 0, '2023-03-10 15:42:10', '2023-03-10 15:42:13', '2023-03-10 15:42:20', 0, 0);
INSERT INTO `user` VALUES (2, 'user', 'salt', 'Ju1u+exzxkzm+8Vy34A5deJLMgyt5LVKSJAlp4iYsQr/sq2nYwO9Dq3hqdNP8o0IBOAVfzTtHo0vZLJdfrJauf2FR5NkYziXiWEtXDS2i8ccYXWE2CKfVQ16eJ7tDl//AlNLQU6lwi6Z4Emn9EmIbOSrkPCFtmpRxjV5bHupqjQ=', '普通用户', 0, '2023-03-10 18:19:51', '2023-03-10 18:19:53', '2023-03-10 18:20:03', 0, NULL);
INSERT INTO `user` VALUES (3, 'user', 'salt', 'Ju1u+exzxkzm+8Vy34A5deJLMgyt5LVKSJAlp4iYsQr/sq2nYwO9Dq3hqdNP8o0IBOAVfzTtHo0vZLJdfrJauf2FR5NkYziXiWEtXDS2i8ccYXWE2CKfVQ16eJ7tDl//AlNLQU6lwi6Z4Emn9EmIbOSrkPCFtmpRxjV5bHupqjQ=', '普通用户', 0, '2023-03-10 18:19:51', '2023-03-10 18:19:53', '2023-03-10 18:20:03', 0, 0);
INSERT INTO `user` VALUES (5, 'user', 'salt', 'Ju1u+exzxkzm+8Vy34A5deJLMgyt5LVKSJAlp4iYsQr/sq2nYwO9Dq3hqdNP8o0IBOAVfzTtHo0vZLJdfrJauf2FR5NkYziXiWEtXDS2i8ccYXWE2CKfVQ16eJ7tDl//AlNLQU6lwi6Z4Emn9EmIbOSrkPCFtmpRxjV5bHupqjQ=', '普通用户', 0, '2023-03-10 18:19:51', '2023-03-10 18:19:53', '2023-03-10 18:20:03', 0, NULL);
...
-- ----------------------------
-- Function structure for authorizeFunction
-- ----------------------------
DROP FUNCTION IF EXISTS `authorizeFunction`;
delimiter ;;
CREATE FUNCTION `authorizeFunction`(authorizeName VARCHAR(255))
 RETURNS int
BEGIN 
  DECLARE result INT;
  SELECT id INTO result FROM authorize WHERE authorize_name = authorizeName;
  RETURN result;
END
;;
delimiter ;
